...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addStringOption((option) =>
			option.setName("mode").setDescription("Search by username or user ID").setRequired(true).setChoices(
				{
					name: "Username",
					value: "username",
				},
		...
		.addStringOption((option) => option.setName("user").setDescription("The user to display").setRequired(true)),
